...
const BlogItem = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-lg">
      ...
      <div className="flex items-center text-gray-600 text-sm mt-4 space-x-6">
        <span className="flex items-center">
          <svg className="w-4 h-4 mr-1 text-purple-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5.121 17.804A9 9 0 1118.879 6.196M12 9v4l3 3" />
          </svg>
          By {blog.author}
        </span>
        <span className="flex items-center">
          <svg className="w-4 h-4 mr-1 text-purple-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7h8M8 11h8m-8 4h8m2 4H6a2 2 0 01-2-2V6c0-1.104.896-2 2-2h12c1.104 0 2 .896 2 2v12c0 1.104-.896 2-2 2z" />
          </svg>
      ...
      {/* Blog Title & Content */}
      <h1 className="text-3xl font-bold text-purple-700 mt-6">{blog.title}</h1>
